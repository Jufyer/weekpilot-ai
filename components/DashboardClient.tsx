...
export default function DashboardPage() {
  ...
  const [calendarActionMessage, setCalendarActionMessage] = useState<string | null>(
    null
  );
  ...
  const [plannedSuggestions, setPlannedSuggestions] = useState<
    PlannedStudySuggestion[]
  >([]);
  ...
  async function handleAddAllSuggestions(
    ...
    try {
      ...
      setCalendarActionMessage(
        "Selected study blocks were added to Google Calendar."
      );
      resetAiOutput();
    } catch (error) {
      setCalendarActionError(
