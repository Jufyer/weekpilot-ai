...
import { PlannedStudySuggestion, StudyTimeDraft } from "@/lib/types";
...
type Props = {
    ...
    onAddAll: (drafts: Array<{ suggestionId: string; draft: StudyTimeDraft }>) => void;
};
            ...
            <div className="mb-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-slate-600">
                        Review and adjust WeekPilot&apos;s suggested study sessions before adding them to Google Calendar.
                    </p>
                </div>
                                ...
                                <div className="mt-4 grid gap-3 md:grid-cols-2">
                                    <label className="block md:col-span-2">
                                        ...
                                        <input
                                            value={draft.title}
                                            onChange={(event) =>
                                                updateDraft(suggestion.id, { title: event.target.value })
                                            }
                                    ...
                                    <label className="block">
                                        ...
                                        <input
                                            ...
                                            value={draft.date}
                                            onChange={(event) =>
                                                updateDraft(suggestion.id, { date: event.target.value })
                                            }
                                            className="mt-1 w-full rounded-xl border border-slate-300 bg-white px-3 py-2"
                                        />
                                    </label>
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        <label className="block">
                                            ...
                                            <input
                                                ...
                                                value={draft.endTime}
                                                onChange={(event) =>
                                                    updateDraft(suggestion.id, { endTime: event.target.value })
                                                }
                                                className="mt-1 w-full rounded-xl border border-slate-300 bg-white px-3 py-2"
                                            />
                                        </label>
